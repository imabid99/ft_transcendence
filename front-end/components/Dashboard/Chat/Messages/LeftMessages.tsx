    ...
    return (
        <div className="flex gap-[16px] items-start"> 
            ...
            <span className="flex flex-col gap-[6px]">
                ...
                <span className="text-[#000] text-[16px] font-[Poppins] font-[500] bg-[#F5F6F7] px-[20px] py-[10px] rounded-bl-[30px] rounded-r-[30px] max-w-[400px] max-sm:max-lg:text-[14px] break-words lsm:max-sm:max-w-[210px] lsm:max-sm:text-[13px]">
                    {message.content}
                </span>
