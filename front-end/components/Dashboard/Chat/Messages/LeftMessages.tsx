    ...
    return (
        <div className="flex gap-[16px] items-start"> 
            ...
            <span className="flex flex-col gap-[6px]">
                <span className="text-[#869caf] text-[15px] font-[Poppins] font-[500] self-start">{sender?.username}</span>
                <span className="text-[#FFF] text-[16px] font-[Poppins] font-[500] bg-[#d6d6d6] px-[20px] py-[10px] rounded-tl-[20px] rounded-r-[20px] max-w-[400px] max-sm:max-lg:text-[14px] break-words lsm:max-sm:max-w-[210px] lsm:max-sm:text-[13px]">
                    {message.content}
                </span>
