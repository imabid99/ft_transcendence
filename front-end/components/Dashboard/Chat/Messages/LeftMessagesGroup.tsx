    ...
    return (
        <div className="flex gap-[16px] items-start"> 
            ...
            <span className="flex flex-col gap-[6px]">
                <span className="text-[#AEAEAE] text-[15px] font-[Poppins] font-[500] self-start  max-w-[150px] truncate ">{message?.fromName}</span>
                <span className="w-fit text-[#FFF] text-[16px] font-[Poppins] font-[500] bg-[#989898] px-[20px] py-[10px] rounded-tl-[30px] rounded-r-[30px] max-w-[400px] max-sm:max-lg:text-[14px] break-words">
                    {message.content}
                </span>
