...
export default function Home() {
    ...
    return (
        <div className="flex flex-col px-[62px] py-[60px] w-[calc(100%-150px)] bg-[#FAFDFF]  ml-[150px] h-[100vh] overflow-y-scroll overflow-x-hidden gap-[52px] relative no-scrollbar">
