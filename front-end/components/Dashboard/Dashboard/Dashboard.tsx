    ...
    return (
        <div ref={dashboardRef} className='bg-[#FFF]  header w-[150px] h-full   shadooow fixed top-0 left-0 z-[100]  overflow-y-scroll no-scrollbar lsm:max-lg:w-[100px] lsm:max-sm:left-[-150px] transition-all duration-300'>
            <div className="flex z-[99] flex-col items-center gap-[30px] w-full min-h-[580px] h-full justify-between relative py-[45px] bg-[#FFF]">
                    <div onClick={
                        () => {
                            setMediaDashbord(false);
                            dashboardRef.current?.classList.remove("!left-0");
                            router.push('/');
                        }
                    } className=" w-full flex justify-center items-center self-start">
                        <Image
                            src="/logo.png"
                            alt=""
                            width={150}
            ...
            {
                mediaDashbord &&
                <div className="sm:hidden min-w-full min-h-full z-[95] flex flex-col items-center justify-center pl-[10px] cursor-pointer self-end fixed top-0 left-0 bg-black bg-opacity-5 backdrop-blur-[1.5px]" onClick={() => {setMediaDashbord(false) ; dashboardRef.current?.classList.remove("!left-0")}}/>
            }
        </div>
    )
}