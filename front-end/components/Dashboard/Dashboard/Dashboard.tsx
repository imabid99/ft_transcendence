...
export default function Nav( {path} : Props) {
    ...
    return (
        <div ref={dashboardRef} className='bg-[#FFF]  header w-[150px] h-full   shadooow fixed top-0 left-0 z-[100]  overflow-y-scroll no-scrollbar lsm:max-lg:w-[100px] lsm:max-sm:left-[-150px] transition-all duration-300'>
            <div className="flex z-[99] flex-col items-center gap-[30px] w-full min-h-[980px] h-full justify-between relative py-[45px] bg-[#FFF]">
                <div>
                    <Link href='/' className="mb-[100px] w-full flex justify-center items-center self-start">
                        <Image
                            src="/logo.png"
                            alt=""
                            width={150}
                    ...
                    <div className="flex flex-col items-center justify-center mt-[50px] gap-[50px]  w-full">
                        <Link href='/'>
            ...
            {
                mediaDashbord &&
                <div className="min-w-full min-h-full z-[95] flex flex-col items-center justify-center pl-[10px] cursor-pointer self-end fixed top-0 left-0 bg-black bg-opacity-50" onClick={() => {setMediaDashbord(false) ; dashboardRef.current?.classList.remove("!left-0")}}/>
            }
        </div>
    )
}