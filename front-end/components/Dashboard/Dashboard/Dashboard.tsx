...
export default function Nav( {path} : Props) {
    ...
    return (
        <div className='bg-[#FFF]  header w-[150px] max-h-[100vh] py-[45px] shadooow fixed top-0 left-0 z-[60]  overflow-y-scroll no-scrollbar lsm:max-lg:w-[100px]'>
            <div className="flex flex-col items-center gap-[50px] w-full min-h-[980px] h-[calc(100vh-90px)]">
                <Link href='/' className="mb-[150px] w-full flex justify-center items-center self-start">
                    <Image
                        src="/logo.png"
                        alt=""
                        width={150}
