...
export default function ChannelInfo({infoRef, handleshowInfo}:ChannelInfoProps) {
    return (
        <div className="h-[100vh] bg-[#FFF] min-w-[684px] fixed right-[-700px] top-0 z-[60] groupInfo p-[42px] flex flex-col gap-[30px] overflow-y-scroll no-scrollbar ease-in duration-300 delay-100"
            ref={infoRef}>
            <span className="w-full flex items-center gap-[34px] cursor-pointer" onClick={handleshowInfo}>
                <span>
            ...
            <div className="w-full flex flex-col gap-[25px] max-h-[400px] overflow-y-scroll no-scrollbar">
