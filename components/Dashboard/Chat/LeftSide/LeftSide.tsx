		...
		<>	
			<div className="chat__left w-[450px]  bg-[#FFF] border-r-[1px] relative overflow-hidden lg:max-xl:w-[350px] lsm:max-lg:w-full">
					<div className="chat__left__head flex justify-between items-center border-b-[1px]  border-[#E5E5E5] pl-[42px] pr-[25px] lsm:max-lg:px-[10px]">
						...
						<div className="z-[10] bg-[#EDFAFF]  cursor-pointer w-[54px] h-[54px] notifShadow flex justify-center items-center rounded-[20px] ">
							<div
					...
					</div>
					{
						!showCreateGroup && (
							<>
								<UsersOnline />
								<div id="scroll" className="max-h-[calc(100%-370px)] overflow-y-scroll no-scrollbar h-[calc(100%-373px)] px-[25px] py-[25px] flex flex-col gap-[25px]">
									<GroupsChannels />
									<UsersDm />
								</div>
								<NewModal setShowCreateGroup={setShowCreateGroup}/>
							</>
						)
					}
					{
						showCreateGroup === 'selectUsers' &&
						(
							<>
								<div className=" flex gap-2 items-center  py-[27px] px-[25px]">
									<span onClick={() => setShowCreateGroup(null)} className="cursor-pointer">
								...
								<form className="max-h-[calc(100%-270px)] min-h-[calc(100%-270px)] overflow-y-scroll no-scrollbar px-[25px] py-[25px]">
									<SelectUsers groupUsers={groupUsers} setGroupUsers={setGroupUsers} user={{name: 'Achraf Sabbar', username: '@asabbar', url: '/userProfile.jpg'}} />
									<SelectUsers groupUsers={groupUsers}  setGroupUsers={setGroupUsers} user={{name: 'Imad abid', username: '@imabid', url: '/userProfile.jpg'}} />
									<SelectUsers groupUsers={groupUsers}  setGroupUsers={setGroupUsers} user={{name: 'Zakaria aitslimam', username: '@zai-sli', url: '/userProfile.jpg'}} />
									<SelectUsers groupUsers={groupUsers}  setGroupUsers={setGroupUsers} user={{name: 'Saad gmira', username: '@sgmira', url: '/userProfile.jpg'}} />
									<SelectUsers groupUsers={groupUsers}  setGroupUsers={setGroupUsers} user={{name: 'Oussama Beaj', username: '@obeaj', url: '/userProfile.jpg'}} />
								</form>
								<div className="  bg-[#025063] min-h-[70px] min-w-[70px] rounded-full absolute bottom-[54px] right-[50px] z-[100] flex justify-center items-center cursor-pointer" onClick={() => { setShowCreateGroup("groupInfo")}}>
									...
									</label>
									{
										groupType === 'protected' && (
											<label htmlFor="protected"  className="groupInfo flex flex-col gap-[10px] mt-[30px] ">
												...
												<input autoFocus type="password" id="protected" className="w-full h-[50px]  px-[20px]   bg-[#F9FCFE] pr-[20px] text-[15px] font-[300] font-[Poppins] text-[#A5BFD6] outline-none rounded-[11px]" placeholder="Password" />
											</label>
										)
									}
