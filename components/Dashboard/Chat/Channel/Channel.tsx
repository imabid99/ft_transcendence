...
export default function Channel({avatar, channel, lastMessage, lastMessageTime, notification, active}: ChannelProps) {
    return (
        <Link href={`/Chat/${channel}`} className="cursor-pointer w-full flex justify-between items-center " >
