...
{
    return (
    <div className="LeaderModal flex flex-col gap-[35px] justify-start min-w-[676px] min-h-[95vh] bg-[#fff] z-[55] top-[50%] right-[-6000px] absolute translate-y-[-50%] rounded-[42px] shadooow ease-in duration-300 delay-100"
        ref={leaderRef}>
