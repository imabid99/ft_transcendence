    ...
    return (
        ...
        ">
                    ...
                    <div className="flex gap-[20px] items-center z-[0] bg-[#FFF] searchShadow rounded-[20px]">
                        <div className="flex items-center gap-[10px] p-[32px] pr-0">
                            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M27 27L21.0974 21.0868M24.3684 13.1842C24.3684 16.1504 23.1901 18.9952 21.0926 21.0926C18.9952 23.1901 16.1504 24.3684 13.1842 24.3684C10.218 24.3684 7.37323 23.1901 5.27578 21.0926C3.17833 18.9952 2 16.1504 2 13.1842C2 10.218 3.17833 7.37323 5.27578 5.27578C7.37323 3.17833 10.218 2 13.1842 2C16.1504 2 18.9952 3.17833 21.0926 5.27578C23.1901 7.37323 24.3684 10.218 24.3684 13.1842Z" stroke="#B4C0CB" stroke-width="3" stroke-linecap="round"/>
                            </svg> 
                        </div>
                ...
                <div className='header__right flex gap-[30px]'>
                    <div className="z-[50] bg-[#FFF]  cursor-pointer w-[88px] h-[90px] notifShadow flex justify-center items-center rounded-[30px] ">
                        <div className="notif relative after:animate-ping">
